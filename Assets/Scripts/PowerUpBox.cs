...
public class PowerUpBox : MonoBehaviour
{
    ...
    [SerializeField] AudioClip rapidFirePowerUpSound;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            GameController.Instance.PlayerPowerUps = PowerUps.RappidFire;
            AudioMannager.Instance.PlaySound(rapidFirePowerUpSound, 1.3f);
